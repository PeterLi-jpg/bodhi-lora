...
# On-demand v4-16 (us-central2-b) — no preemption.
# v4-16 = 2x2x2 = 2 hosts × 8 chips; pipeline SSHes to worker 0 (8 chips).
# Format: "TPU_TYPE ZONE SPOT(yes/no) _UNUSED_CFG"
TRC_SLOTS=(
    "v4-16 us-central2-b no tpu/accelerate_config_v6e8.yaml"
)
